...
public class CreateAssemblyFromRevisionsExample extends CommandLineOptions {
    ...
    public void run() {
        ...
        List<CompletableFuture<Part>> futureParts = ProgressBar.wrap(getPartFiles().stream(),"Parts")//Stream.of("16000_16000.jt", "redo/sooo-many/2043904/2043904_2043904_200_10_10_2Instanced.tgz", "redo/cubey/160_160_1000_10_10_10Instanced.tgz")
        ...
        List<Part> newParts = ProgressBar.wrap(futureParts.stream(),"Creating parts")
        ...
        try {
            Part assembly =
                    ProgressBar.wrap(newParts.stream(),"Creating assembly ["+getAssemblyName()+"]")
                            ...
                            .collect(Collectors.collectingAndThen(Collectors.toList(), (l) -> pc.createAssemblyFromRevisions(l, "gbiv-assembly" + UUID.randomUUID())))
                            .handle((part, ex) -> {
                                if (ex != null) {
