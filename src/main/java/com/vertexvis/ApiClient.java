...
public class ApiClient {
  ...
  public ApiClient(String basePath, String clientId, String clientSecret,
    ...
    RetryingOAuth retryingOAuth =
        new RetryingOAuth(tokenUrl, clientId, OAuthFlow.application, clientSecret, parameters);
    authentications.put(
        "OAuth2",
        retryingOAuth
    );
  ...
  private void init() {
    ...
    setUserAgent("vertex-api-client-java/0.1.0");
  ...
  public Call buildCall(String path, String method, List<Pair> queryParams,
      ...
      throws ApiException {
    Request request =
        buildRequest(path, method, queryParams, collectionQueryParams, body, headerParams,
  ...
  public RequestBody buildRequestBodyMultipart(Map<String, Object> formParams) {
    ...
    for (Entry<String, Object> param : formParams.entrySet()) {
      if (param.getValue() instanceof File) {
        ...
        mpBuilder
            .addPart(partHeaders, RequestBody.create(parameterToString(param.getValue()), null));
      }
    }
