...
public class ScenesApi {
    ...
    /**
     * Build call for createSceneSyncJob
     ...
     */
    public okhttp3.Call createSceneSyncJobCall(UUID id, CreateSceneSyncRequest createSceneSyncRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        ...
        // create path and map variables
        String localVarPath = "/scenes/{id}/scene-item-updates"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createSceneSyncJobValidateBeforeCall(UUID id, CreateSceneSyncRequest createSceneSyncRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createSceneSyncJob(Async)");
        }
        
        // verify the required parameter 'createSceneSyncRequest' is set
        if (createSceneSyncRequest == null) {
            throw new ApiException("Missing the required parameter 'createSceneSyncRequest' when calling createSceneSyncJob(Async)");
        }
        

        okhttp3.Call localVarCall = createSceneSyncJobCall(id, createSceneSyncRequest, _callback);
        return localVarCall;
     ...
     */
    public QueuedJob createSceneSyncJob(UUID id, CreateSceneSyncRequest createSceneSyncRequest) throws ApiException {
        ApiResponse<QueuedJob> localVarResp = createSceneSyncJobWithHttpInfo(id, createSceneSyncRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<QueuedJob> createSceneSyncJobWithHttpInfo(UUID id, CreateSceneSyncRequest createSceneSyncRequest) throws ApiException {
        okhttp3.Call localVarCall = createSceneSyncJobValidateBeforeCall(id, createSceneSyncRequest, null);
     ...
     */
    public okhttp3.Call createSceneSyncJobAsync(UUID id, CreateSceneSyncRequest createSceneSyncRequest, final ApiCallback<QueuedJob> _callback) throws ApiException {

        okhttp3.Call localVarCall = createSceneSyncJobValidateBeforeCall(id, createSceneSyncRequest, _callback);
        Type localVarReturnType = new TypeToken<QueuedJob>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
