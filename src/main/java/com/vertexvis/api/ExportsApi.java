...
public class ExportsApi {
    ...
    public QueuedJob createExport(CreateExportRequest createExportRequest) throws ApiException {
        ApiResponse<QueuedJob> localVarResp = createExportWithHttpInfo(createExportRequest);
    ...
    public ApiResponse<QueuedJob> createExportWithHttpInfo(CreateExportRequest createExportRequest) throws ApiException {
        okhttp3.Call localVarCall = createExportValidateBeforeCall(createExportRequest, null);
     ...
     */
    public okhttp3.Call createExportAsync(CreateExportRequest createExportRequest, final ApiCallback<QueuedJob> _callback) throws ApiException {

        okhttp3.Call localVarCall = createExportValidateBeforeCall(createExportRequest, _callback);
        Type localVarReturnType = new TypeToken<QueuedJob>(){}.getType();
     ...
     * @param id The &#x60;export&#x60; ID. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getExportAsync(UUID id, final ApiCallback<Export> _callback) throws ApiException {
    ...
    /**
     * Build call for getQueuedExport
     * @param id The &#x60;queued-export&#x60; ID. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public QueuedJob getQueuedExport(UUID id) throws ApiException {
        ApiResponse<QueuedJob> localVarResp = getQueuedExportWithHttpInfo(id);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<QueuedJob> getQueuedExportWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = getQueuedExportValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<QueuedJob>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getQueuedExportAsync(UUID id, final ApiCallback<QueuedJob> _callback) throws ApiException {

        okhttp3.Call localVarCall = getQueuedExportValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<QueuedJob>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
