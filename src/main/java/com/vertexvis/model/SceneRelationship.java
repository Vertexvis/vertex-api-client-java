...
public class SceneRelationship {
  ...
  public SceneRelationship data(SceneRelationshipData data) {
  ...
  **/
  ...
  public void setData(SceneRelationshipData data) {
    this.data = data;
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SceneRelationship
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SceneRelationship.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SceneRelationship.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SceneRelationship` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      SceneRelationshipData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
