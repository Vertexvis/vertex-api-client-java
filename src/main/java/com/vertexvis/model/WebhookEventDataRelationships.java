...
public class WebhookEventDataRelationships {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookEventDataRelationships
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookEventDataRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookEventDataRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookEventDataRelationships` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      WebhookEventDataRelationshipsOwner.validateJsonObject(jsonObj.getAsJsonObject("owner"));
      // validate the required field `resource`
      WebhookEventDataRelationshipsResource.validateJsonObject(jsonObj.getAsJsonObject("resource"));
  }
