...
public class Matrix4Nullable {
  ...
  public Matrix4Nullable r0(@javax.annotation.Nonnull Vector4 r0) {
    this.r0 = r0;
    return this;
  }
  ...
  public Matrix4Nullable r1(@javax.annotation.Nonnull Vector4 r1) {
    this.r1 = r1;
    return this;
  }
  ...
  public Matrix4Nullable r2(@javax.annotation.Nonnull Vector4 r2) {
    this.r2 = r2;
    return this;
  }
  ...
  public Matrix4Nullable r3(@javax.annotation.Nonnull Vector4 r3) {
    this.r3 = r3;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Matrix4Nullable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Matrix4Nullable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Matrix4Nullable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Matrix4Nullable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
