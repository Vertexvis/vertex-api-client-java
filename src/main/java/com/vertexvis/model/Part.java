...
public class Part {
  ...
  public Part data(@javax.annotation.Nonnull PartData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull PartData data) {
    this.data = data;
  }


  public Part included(@javax.annotation.Nullable List<PartRevisionData> included) {
  ...
  public void setIncluded(@javax.annotation.Nullable List<PartRevisionData> included) {
    this.included = included;
  }


  public Part links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      PartData.validateJsonElement(jsonObj.get("data"));
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull()) {
        ...
        if (jsonArrayincluded != null) {
          ...
          for (int i = 0; i < jsonArrayincluded.size(); i++) {
            PartRevisionData.validateJsonElement(jsonArrayincluded.get(i));
          };
        }
      }
  }
