...
public class WebhookSubscription {
  ...
  private WebhookSubscriptionData data;
  ...
  **/
  ...
  public WebhookSubscriptionData getData() {
    return data;
  }


  public void setData(WebhookSubscriptionData data) {
    this.data = data;
  }


  public WebhookSubscription links(Map<String, Link> links) {
    
    this.links = links;
    return this;
  }

  public WebhookSubscription putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, webhookSubscription.data) &&
        Objects.equals(this.links, webhookSubscription.links);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookSubscription
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookSubscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookSubscription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSubscription` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      WebhookSubscriptionData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
