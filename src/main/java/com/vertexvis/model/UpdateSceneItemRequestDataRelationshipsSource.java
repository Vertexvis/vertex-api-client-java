...
public class UpdateSceneItemRequestDataRelationshipsSource extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateSceneItemRequestDataRelationshipsSource>() {
                ...
                public UpdateSceneItemRequestDataRelationshipsSource read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for UpdateSceneItemRequestDataRelationshipsSource: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateSceneItemRequestDataRelationshipsSource(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateSceneItemRequestDataRelationshipsSource
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for UpdateSceneItemRequestDataRelationshipsSource with anyOf schemas: GeometrySetRelationship, PartRevisionRelationship. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
