...
public class TranslationInspectionJob {
  ...
  public TranslationInspectionJob data(TranslationInspectionJobData data) {
  ...
  **/
  ...
  public void setData(TranslationInspectionJobData data) {
    this.data = data;
  }


  public TranslationInspectionJob links(Map<String, Link> links) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TranslationInspectionJob
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TranslationInspectionJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TranslationInspectionJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TranslationInspectionJob` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      TranslationInspectionJobData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
