...
public class Scene {
  ...
  public Scene data(SceneData data) {
  ...
  **/
  ...
  public Scene links(Map<String, Link> links) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Scene.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      SceneData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
