...
public class CreateSceneItemRequestDataRelationshipsSource extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateSceneItemRequestDataRelationshipsSource>() {
                ...
                public CreateSceneItemRequestDataRelationshipsSource read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for CreateSceneItemRequestDataRelationshipsSource: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateSceneItemRequestDataRelationshipsSource(GeometrySetRelationship o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSceneItemRequestDataRelationshipsSource(PartRevisionRelationship o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateSceneItemRequestDataRelationshipsSource(SceneRelationship o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSceneItemRequestDataRelationshipsSource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for CreateSceneItemRequestDataRelationshipsSource with anyOf schemas: GeometrySetRelationship, PartRevisionRelationship, SceneRelationship. JSON: %s", jsonObj.toString()));
    }
  }
