...
import com.vertexvis.model.AccountData;
...
public class Account {
  ...
  **/
  ...
  public Account links(Map<String, Link> links) {
    
    this.links = links;
    return this;
  }

  public Account putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, account.data) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      AccountData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
