 ...
 */
@ApiModel(description = "This is the relationship from the instance to the parent revision")
...
public class PartRevisionInstanceDataRelationships {
  ...
  public PartRevisionInstanceDataRelationships partRevision(PartRevisionRelationship partRevision) {
