...
public class CreateSceneViewRequestData {
  ...
  public CreateSceneViewRequestData type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public CreateSceneViewRequestData attributes(@javax.annotation.Nonnull CreateSceneViewRequestDataAttributes attributes) {
  ...
  public void setAttributes(@javax.annotation.Nonnull CreateSceneViewRequestDataAttributes attributes) {
    this.attributes = attributes;
  }


  public CreateSceneViewRequestData relationships(@javax.annotation.Nullable CreateSceneViewRequestDataRelationships relationships) {
  ...
  public void setRelationships(@javax.annotation.Nullable CreateSceneViewRequestDataRelationships relationships) {
    this.relationships = relationships;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSceneViewRequestData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSceneViewRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSceneViewRequestData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSceneViewRequestData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      CreateSceneViewRequestDataAttributes.validateJsonElement(jsonObj.get("attributes"));
      // validate the optional field `relationships`
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        CreateSceneViewRequestDataRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
  }
