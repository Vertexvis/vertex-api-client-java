...
public class ViewRenByIdOp {
  ...
  public ViewRenByIdOp type(TypeEnum type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "view-rendition-by-id", required = true, value = "Resource object type.")
  ...
  public ViewRenByIdOp renditionId(UUID renditionId) {
