...
public class SceneAlterationList {
  ...
  public SceneAlterationList data(@javax.annotation.Nonnull List<SceneAlterationData> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<SceneAlterationData> data) {
    this.data = data;
  }


  public SceneAlterationList links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SceneAlterationList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SceneAlterationList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SceneAlterationList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SceneAlterationList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        SceneAlterationData.validateJsonElement(jsonArraydata.get(i));
      };
  }
