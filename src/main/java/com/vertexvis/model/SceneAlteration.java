...
public class SceneAlteration {
  ...
  public SceneAlteration data(@javax.annotation.Nonnull SceneAlterationData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull SceneAlterationData data) {
    this.data = data;
  }


  public SceneAlteration links(@javax.annotation.Nullable Map<String, Link> links) {
    this.links = links;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SceneAlteration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SceneAlteration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SceneAlteration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SceneAlteration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      SceneAlterationData.validateJsonElement(jsonObj.get("data"));
  }
