...
public class ColorMaterialNullable {
  ...
  public ColorMaterialNullable opacity(@javax.annotation.Nonnull Integer opacity) {
  ...
  public ColorMaterialNullable glossiness(@javax.annotation.Nonnull Integer glossiness) {
  ...
  public ColorMaterialNullable ambient(@javax.annotation.Nonnull Color3 ambient) {
  ...
  public ColorMaterialNullable diffuse(@javax.annotation.Nonnull Color3 diffuse) {
  ...
  public ColorMaterialNullable specular(@javax.annotation.Nonnull Color3 specular) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ColorMaterialNullable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColorMaterialNullable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColorMaterialNullable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ColorMaterialNullable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
