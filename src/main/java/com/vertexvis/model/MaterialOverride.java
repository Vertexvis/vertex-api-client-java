...
public class MaterialOverride {
  ...
  public MaterialOverride value(@javax.annotation.Nullable ColorMaterial value) {
    this.value = value;
    return this;
  }
  ...
  public void setValue(@javax.annotation.Nullable ColorMaterial value) {
    this.value = value;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MaterialOverride
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MaterialOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MaterialOverride.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MaterialOverride` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `value`
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        ColorMaterial.validateJsonElement(jsonObj.get("value"));
      }
  }
