...
public class PartDataRelationships {
  ...
  public PartDataRelationships partRevisions(@javax.annotation.Nonnull List<PartDataRelationshipsPartRevisions> partRevisions) {
  ...
  public void setPartRevisions(@javax.annotation.Nonnull List<PartDataRelationshipsPartRevisions> partRevisions) {
    this.partRevisions = partRevisions;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraypartRevisions.size(); i++) {
        PartDataRelationshipsPartRevisions.validateJsonElement(jsonArraypartRevisions.get(i));
      };
  }
