...
public class MetadataLongType {
  ...
  public MetadataLongType type(String type) {
  ...
  **/
  ...
  public MetadataLongType value(Long value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetadataLongType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetadataLongType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MetadataLongType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetadataLongType` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
