...
public class AdminLoginAcceptRequestData {
  ...
  public AdminLoginAcceptRequestData type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public AdminLoginAcceptRequestData attributes(@javax.annotation.Nonnull AdminLoginAcceptRequestDataAttributes attributes) {
  ...
  public void setAttributes(@javax.annotation.Nonnull AdminLoginAcceptRequestDataAttributes attributes) {
    this.attributes = attributes;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminLoginAcceptRequestData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminLoginAcceptRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminLoginAcceptRequestData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminLoginAcceptRequestData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      AdminLoginAcceptRequestDataAttributes.validateJsonElement(jsonObj.get("attributes"));
  }
