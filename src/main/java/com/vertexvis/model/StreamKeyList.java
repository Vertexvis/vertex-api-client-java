...
public class StreamKeyList {
  ...
  private List<StreamKeyData> data = new ArrayList<>();
  ...
  public StreamKeyList data(@javax.annotation.Nonnull List<StreamKeyData> data) {
    this.data = data;
    return this;
  }

  public StreamKeyList addDataItem(StreamKeyData dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nonnull List<StreamKeyData> data) {
    this.data = data;
  }


  public StreamKeyList links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public StreamKeyList putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  public boolean equals(Object o) {
    ...
    StreamKeyList streamKeyList = (StreamKeyList) o;
    return Objects.equals(this.data, streamKeyList.data) &&
        Objects.equals(this.links, streamKeyList.links);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamKeyList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamKeyList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamKeyList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamKeyList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        StreamKeyData.validateJsonElement(jsonArraydata.get(i));
      };
  }
