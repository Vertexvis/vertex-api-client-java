...
public class QueryBySceneItemIds {
  ...
  private List<QueryBySceneItemId> values = new ArrayList<>();
  ...
  **/
  ...
  public QueryBySceneItemIds values(List<QueryBySceneItemId> values) {
  ...
  **/
  ...
  public List<QueryBySceneItemId> getValues() {
    return values;
  }


  public void setValues(List<QueryBySceneItemId> values) {
    this.values = values;
  }
