...
public class HitResultData {
  ...
  public HitResultData type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public HitResultData id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public HitResultData attributes(@javax.annotation.Nonnull HitResultDataAttributes attributes) {
  ...
  public void setAttributes(@javax.annotation.Nonnull HitResultDataAttributes attributes) {
    this.attributes = attributes;
  }


  public HitResultData relationships(@javax.annotation.Nonnull HitResultDataRelationships relationships) {
  ...
  public void setRelationships(@javax.annotation.Nonnull HitResultDataRelationships relationships) {
    this.relationships = relationships;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HitResultData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HitResultData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HitResultData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HitResultData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      HitResultDataAttributes.validateJsonElement(jsonObj.get("attributes"));
      // validate the required field `relationships`
      HitResultDataRelationships.validateJsonElement(jsonObj.get("relationships"));
  }
