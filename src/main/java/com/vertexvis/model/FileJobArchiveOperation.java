...
public class FileJobArchiveOperation {
  ...
  private List<ArchiveManifestEntry> manifest = new ArrayList<>();
  ...
  **/
  ...
  public FileJobArchiveOperation manifest(List<ArchiveManifestEntry> manifest) {
  ...
  **/
  ...
  public List<ArchiveManifestEntry> getManifest() {
    return manifest;
  }


  public void setManifest(List<ArchiveManifestEntry> manifest) {
    this.manifest = manifest;
  }
