...
public class Matrix4 {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Matrix4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Matrix4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Matrix4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Matrix4` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
