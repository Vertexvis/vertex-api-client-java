...
public class FileList {
  ...
  public FileList data(@javax.annotation.Nonnull List<FileMetadataData> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<FileMetadataData> data) {
    this.data = data;
  }


  public FileList links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        FileMetadataData.validateJsonElement(jsonArraydata.get(i));
      };
  }
