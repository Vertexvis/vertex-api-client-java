...
import com.vertexvis.model.AccountDataAttributes;
...
public class AccountData {
  ...
  **/
  ...
  public AccountData attributes(AccountDataAttributes attributes) {
  ...
  **/
  ...
  public AccountDataAttributes getAttributes() {
    return attributes;
  }


  public void setAttributes(AccountDataAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, accountData.type) &&
        ...
        Objects.equals(this.attributes, accountData.attributes);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AccountData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountData` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      AccountDataAttributes.validateJsonObject(jsonObj.getAsJsonObject("attributes"));
  }
